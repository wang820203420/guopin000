...
#import "ToTheGoodsViewController.h"
#import "MainViewController.h"
#import "ChangeBtn.h"
#import "ToDetailViewController.h"
#import "ToSouchViewController.h"
#import "ToGoodsCell.h"//要货
#import "ToGoosdModel.h"

#import "AllStoreCell.h"//全部店铺
#import "AllStoreModel.h"
@interface ToTheGoodsViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
{
...
@implementation ToTheGoodsViewController
...
-(void)openSouchAction:(UIButton *)sender
{
    ...
    ToSouchViewController *stockShCtrl = [[ToSouchViewController alloc]init];
...
-(void)download
{
    ...
    [self juhua];
    NSString *str = [NSString stringWithFormat:@GetStoreNeedOrderListByPageUrl];
    ...
    [AFHTTPClientV2 requestWithBaseURLStr:str
                                  ...
                                  success:^(AFHTTPClientV2 *request, id responseObject)
     {
         ...
         //保存下载的数据用于缓存
         [CacheManager saveCacheWithObject:responseObject ForURLKey:@"5" AndType:CacheTypeQuestion];
         ...
         if ([dict isKindOfClass:[NSDictionary class]]) {
             ...
             if ([dic isKindOfClass:[NSDictionary class]]) {
                 ...
                 for (NSDictionary *dict in arr1) {
                     ...
                     ToGoosdModel *model = [[[ToGoosdModel alloc]init]initWithDictionary:sssDict];
...
-(void)Caches
{
    if ([CacheManager readCacheWithURLKey:@"5" andType:CacheTypeQuestion]) {
        
        id result = [CacheManager readCacheWithURLKey:@"5" andType:CacheTypeQuestion];
        ...
        switch (status) {
            ...
            case AFNetworkReachabilityStatusNotReachable:
                ...
                if (self.dataArray != nil) {
                    ...
                    if ([CacheManager readCacheWithURLKey:@"5" andType:CacheTypeQuestion]!= nil) {
