//
//  GoodsMngViewController.m
//  guoping
//
//  Created by zhisu on 15/9/16.
//  Copyright (c) 2015年 zhisu. All rights reserved.
//

#import "GoodsMngViewController.h"
...
#import "AddViewController.h"//新增
@interface GoodsMngViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation GoodsMngViewController
...
- (void)viewDidLoad {
 ...
 _selectedButton = [ChangeBtn buttonWithType:UIButtonTypeSystem];
    ...
    [self addNavButton:CGRectMake(ScreenWidth-40, ScreenHeight/25, 40, 30)  imageName:@"jiahao@2x" target:self action:@selector(addAction:)];
...
-(void)openSouchAction:(UIButton *)sender
{
    ...
    SouchMngViewController *mngCtrl = [[SouchMngViewController alloc]init];
...
-(void)download
{
    ...
    [self juhua];
    NSString *str = [NSString stringWithFormat:@GetGoodsListByPageUrl];
